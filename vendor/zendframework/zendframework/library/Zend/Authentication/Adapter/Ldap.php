	...
	public function authenticate() {
		...
		foreach ( $this->options as $options ) {
			...
			try {
				...
				/*
				 * Fixes problem when authenticated user is not allowed to retrieve group-membership information or own account. This requires that the user specified with "username" and optionally "password" in the Zend\Ldap\Ldap options is able to retrieve the required information.
				 */
				$requireRebind = false;
