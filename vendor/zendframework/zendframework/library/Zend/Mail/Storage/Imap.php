...
class Imap extends AbstractStorage implements Folder\FolderInterface, Writable\WritableInterface {
	...
	/*
	 * Get raw content of message or part @param int $id number of message @param null|array|string $part path to part or null for message content @return string raw content @throws \Zend\Mail\Protocol\Exception\RuntimeException @throws Exception\RuntimeException
	 */
