...
-- Database: `sandi`
--
CREATE DATABASE IF NOT EXISTS `sandi` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `sandi`;
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模型分类表';
...
--
-- Table structure for table `t_model_file`
--

CREATE TABLE IF NOT EXISTS `t_model_file` (
...
CREATE TABLE IF NOT EXISTS `t_purchase` (
  ...
  `status` int(11) NOT NULL COMMENT '1:已订购 2：已付款 3： 已下载',
