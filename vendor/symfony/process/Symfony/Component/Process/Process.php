...
class Process {
	 ...
	 *
	 * @return integer null process id if running, null otherwise
	 *        
	 ...
	 *
	 * @return float null timeout in seconds or null if it's disabled
	 */
	 ...
	 *
	 * @return string null current working directory or null on failure
	 */
	 ...
	 *
	 * @return string null current contents
	 */
	 ...
	 *        	Whether to use a clocking read call.
	 */
