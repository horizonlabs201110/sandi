...
abstract class Barcode {
	...
	public static function factory($barcode, $renderer = 'image', $barcodeConfig = array(), $rendererConfig = array(), $automaticRenderError = true) {
		/*
		 * Convert Traversable argument to plain string barcode name and separate config object.
		 */
	...
	public static function makeBarcode($barcode, $barcodeConfig = array()) {
		...
		/*
		 * Convert Traversable argument to plain string barcode name and separate configuration.
		 */
		if ($barcode instanceof Traversable) {
			$barcode = ArrayUtils::iteratorToArray ( $barcode );
