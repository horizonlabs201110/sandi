...
class Ip extends AbstractValidator {
	...
	protected function validateIPvFuture($value) {
		/*
		 * ABNF: IPvFuture = "v" 1*HEXDIG "." 1*( unreserved / sub-delims / ":" ) unreserved = ALPHA / DIGIT / "-" / "." / "_" / "~" sub-delims = "!" / "$" / "&" / "'" / "(" / ")" / "*" / "+" / "," / ";" / "="
		 */
		...
		/*
		 * "As such, implementations must not provide the version flag for the existing IPv4 and IPv6 literal address forms described below."
		 */
