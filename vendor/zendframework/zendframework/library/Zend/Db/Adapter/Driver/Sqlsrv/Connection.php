...
class Connection implements ConnectionInterface, Profiler\ProfilerAwareInterface {
	...
	public function beginTransaction() {
		...
		/*
		 * $this->resource->autocommit(false); $this->inTransaction = true;
		 */
	}
	...
	public function commit() {
		...
		/*
		 * if (!$this->resource) { $this->connect(); } $this->resource->commit(); $this->inTransaction = false;
		 */
	}
	...
	public function rollback() {
		...
		/*
		 * if (!$this->resource) { throw new \Exception('Must be connected before you can rollback.'); } if (!$this->_inCommit) { throw new \Exception('Must call commit() before you can rollback.'); } $this->resource->rollback(); return $this;
		 */
	}
